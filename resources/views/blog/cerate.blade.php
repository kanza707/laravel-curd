...
<body>
  ...
  @if ($errors->any())
  <div class="conatiner alert-danger">
      ...
      <div class="col-lg-12">
        <form class="row g-3" action="{{ route('blog.store') }}" method="post">
          ...
          <div class="col-md-6">
            ...
            @enderror" id="inputAddress" placeholder="1234 Main St" name="name" value="{{ old('author') }}">
          </div>
          <div class="col-md-6">
            <label for="inputEmail4" class="form-label">Email</label>
            <input type="email" class="form-control  @error('email') is-invalid
            @enderror" id="inputEmail4" name="email" value="{{ old('email') }}">
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-12">
            ...
            @enderror" id="exampleFormControlTextarea1" rows="3" name="content" value="{{ old('content') }}"></textarea></textarea>
          </div>
